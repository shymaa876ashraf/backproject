...
<body>
    ...
    <nav class="navbar navbar-default navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
              <li><a href="signin.blade.php">SignIn</a></li>
              <li><a href="register.blade.php">Resister</a></li>
            </ul>
      ...
      <div class="login-form">
        ...
        <form  method="post"  action="showproduct.blade.php">
            ...
            <div class="form-group">
                <div class="input-group">
                    <span class="input-group-addon glyphicon glyphicon-envelope"><i class="fa fa-user"></i></span>
            ...
            <div class="form-group">
                <div class="input-group">
                    <span class="input-group-addon glyphicon glyphicon-lock"><i class="fa fa-user"></i></span>
                    <input type="text" class="form-control" name="Resetpassward" placeholder="Resetpassward" required="required">				
                </div>
            </div>       
            <div class="form-group">
